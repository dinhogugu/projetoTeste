...
<script>
   ...
   export default {
     ...
     methods: {
      ...
      //  METODO RESPONSAVEL POR BUSCAR AS INFORMACOES DO DESENVOLVEDOR PARA ALTERACAO USANDO POST
      ...
      // METODO USADO PARA ALTERAR O DESENVOLVEDOR, VIA PUT
