...
<script>
   ...
   export default {
     ...
     methods: {
       ...
       //METODO RETORNA TODOS OS DESENVOLVEDORES VIA GET
      ...
      // METODO RETORNA AS O RESULTADO DOS PARAMETROS PASSADOS VIA GET
      ...
      // METODO ENVIA O PARAMETRO ID VIA GET E RETORNA
      ...
      // METODO DE DIRECIONAMENTO VALIDA PARA VERIFICAR QUAL METODO DEVE CHAMAR MEDIANTE PARAMETRO
      ...
      // DELETA O REGISTRO, UTILIZANDO O METODO DELETE
